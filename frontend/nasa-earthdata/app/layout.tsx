...
export const metadata: Metadata = {
  title: "TEMPO Air Quality Monitor",
  description: "Real-time air quality monitoring powered by NASA's TEMPO mission data. Stay informed about air pollution levels and protect your health.",
};
